...
export default function GameScreen({ user, onLogout }) {
  ...
  const handleStartGame = () => {
    console.log("Start Game logic coming soon!");
  };
    ...
    >
      ...
      <div className="dashboard-body">
        ...
        <div className="dashboard-sidebar">
          <p>
            WELCOME TO SHADOW CLASH,<br />A RETRO-STYLE BATTLE GAME.<br />PREPARE TO FIGHT!<br />
            Shadow Clash is a fast-paced 2D retro-style fighting game that blends classic arcade aesthetics with modern web technology.
            Designed with a neon-pixel art theme and game-inspired UI, it immerses players in a nostalgic yet responsive combat experience.
            The game is built using React for the frontend and Node.js + MongoDB for backend management, ensuring smooth performance and scalable architecture.
